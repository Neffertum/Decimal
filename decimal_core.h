...
int s21_bit_swap(int bits, int bit);
...
// for debug
void s21_print_decimal_bin(s21_decimal decim);
void s21_print_decimal_int(s21_decimal decimal_int);
int s21_get_exp(s21_decimal decim);
int s21_set_exp(s21_decimal *decim, int new_exp);
int s21_swap_int(int *value1, int *value2);
...
s21_decimal s21_bit_negative(s21_decimal decim);
s21_decimal s21_bit_or(s21_decimal decim1, s21_decimal decim2);
